...
def moteur_right_arm_1(position):
    ...
    controle_moteur(int(cfg["moteurs"]["epaule_x_right_pin"]), int(angle))
...
def moteur_right_arm_2(position):
    ...
    controle_moteur(int(cfg["moteurs"]["epaule_y_right_pin"]), int(angle))
...
def moteur_right_arm_3(position):
    ...
    controle_moteur(int(cfg["moteurs"]["epaule_z_right_pin"]), int(angle))
...
def moteur_right_arm_4(position):
    ...
    controle_moteur(int(cfg["moteurs"]["coude_right_pin"]), int(angle))